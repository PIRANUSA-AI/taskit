...
export default function Welcome() {
  ...
  return (
    <div className="min-h-[100dvh] bg-paper relative overflow-x-hidden overflow-y-auto aurora">
      ...
      >
        <BrandMark size={30} />
        <span className="text-sm font-semibold tracking-tight text-navy">PIRANUSA</span>
      </motion.div>
      ...
      <footer className="fixed bottom-4 inset-x-0 text-center text-[11px] text-slate-400 z-10 pointer-events-none">
        TASKIT  Contrivention &copy; 2026. by Piranusa, Indonesia.
      </footer>
    </div>
  )
}
  ...
  return (
    <div className="text-center">
      ...
      <p className="mt-2 text-[13px] text-ink-muted">
        {isSignup
          ? 'Pilih username dan password buat tim internal PIRANUSA.'
